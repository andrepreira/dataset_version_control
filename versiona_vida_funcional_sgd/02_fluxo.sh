...
python3 gera_classificacao.py --dataset_id 1 --rubrix erro_rubrix_v2 --id_versao_modelo_ml 6 --id_versao_diff 7 --versao_id 5 --nome_pipeline sgd_pipeline_v2 --nome_pipeline_antigo sgd_pipeline_v1 --nome_dataset dataset_corrigido_v2
