...
python3 gera_classificacao.py --dataset_id 1 --rubrix erro_rubrix_v3 --id_versao_modelo_ml 10 --id_versao_diff 11 --versao_id 9 --nome_pipeline sgd_pipeline_v3 --nome_pipeline_antigo sgd_pipeline_v2 --nome_dataset dataset_corrigido_v3
