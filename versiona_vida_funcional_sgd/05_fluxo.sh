...
python3 gera_classificacao.py --dataset_id 1 --rubrix erro_rubrix_v5 --id_versao_modelo_ml 18 --id_versao_diff 19 --versao_id 17 --nome_pipeline sgd_pipeline_v5 --nome_pipeline_antigo sgd_pipeline_v4 --nome_dataset dataset_corrigido_v5
