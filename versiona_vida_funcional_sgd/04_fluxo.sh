...
python3 gera_classificacao.py --dataset_id 1 --rubrix erro_rubrix_v4 --id_versao_modelo_ml 14 --id_versao_diff 15 --versao_id 13 --nome_pipeline sgd_pipeline_v4 --nome_pipeline_antigo sgd_pipeline_v3 --nome_dataset dataset_corrigido_v4
